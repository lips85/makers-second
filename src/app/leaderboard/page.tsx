...
import { useLeaderboardQuery, useMyRankQuery } from '@/hooks/useLeaderboardQuery'
...
export default function LeaderboardPage() {
  ...
  // URL 파라미터에서 상태 읽기
  const scopeFromUrl = searchParams.get('scope') as 'global' | 'school' || 'global'
  ...
  // URL 파라미터 변경 감지
  useEffect(() => {
    const newScope = searchParams.get('scope') as 'global' | 'school' || 'global'
    const newOrgId = searchParams.get('orgId') || undefined
    
    console.log('URL 파라미터 감지:', { newScope, newOrgId, currentScope: scope, currentOrgId: orgId })
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <RefreshCw className={`h-4 w-4 mr-2 ${isLeaderboardLoading ? 'animate-spin' : ''}`} />
            새로고침
          </Button>
          {isConnected && (
